...
<xsl:template match="/data">
	...
	For prices or general enquiries, contact Jeremy via the details on the contact page.</p>
			...
			<span id="portfolio-main-image"></span>
			
		</div><!--/#primary-content-portfolio-main-->
		
						<div id="secondary-content-portfolio-main">
							
							<ul>
									<xsl:apply-templates select="gallery-categories/entry" mode="portfolio-category-navigation" />
